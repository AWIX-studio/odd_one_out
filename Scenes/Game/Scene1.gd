...
var current_start : String = 'START1' # Буффер-переменная чтобы понимать, какой именно диалог запускать. Но лучше запускать всё вручную.
var Vakumi : int
var Nakima : int
